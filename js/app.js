!function () {
    ...
    // Most mobile device don't allow playing a sound without user interaction
    var isMobileDevice = isMobileOrTablet();
    ...
    function playRandomPewPewSounds(audioElement, pewpew1, pewpew2) {
        var nextPewPew = Math.random() * 1500;
    ...
    function mobilePewPew(pewpew1, pewpew2) {
        var nextPewPew = Math.random() * 1500;

        setTimeout(function () {
            flashPewPews(pewpew1, pewpew2);
            mobilePewPew(pewpew1, pewpew2);
        }, nextPewPew);
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (isMobileDevice) {
            return mobilePewPew(pewpew1, pewpew2);
        }
